...
# MAGIC SELECT vc.*
# MAGIC FROM dev.mohit_gangwani.content_with_null_cognet_new_table_backfill_test AS vc
# MAGIC JOIN (
...
# MAGIC --  AND exs_report.mt_start <=> new_report.mt_start
# MAGIC  GROUP BY 2
# MAGIC )
# MAGIC UNION
...
# MAGIC --- should return 0.
# MAGIC select count(*)
# MAGIC from dev.mohit_gangwani.content_with_null_cognet_new_table_backfill_test
